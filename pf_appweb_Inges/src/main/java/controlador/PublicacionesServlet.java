...
public class PublicacionesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            // Obtener publicaciones ancladas
            List<PostDTO> anclados = postDAO.obtenerPublicacionesAncladas();

            // Obtener publicaciones recientes
            List<PostDTO> publicaciones = postDAO.obtenerTodasLasPublicaciones();

            // Asociar comentarios a las publicaciones
            for (PostDTO post : publicaciones) {
                post.setComentarios(comentarioDAO.obtenerComentariosPorPublicacion(post.getId()));
            }
            ...
            e.printStackTrace();
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "Error al cargar publicaciones.");
        }
